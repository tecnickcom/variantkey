...
func getEsidTestData() []TEsidData {
	return []TEsidData{
...
func getEsidNumTestData() []TEsidNumData {
	const (
		esidNumABC000000012345678   = "ABC:000000012345678"
		esidNumABCDE000000012345678 = "ABCDE:000000012345678"
	)
	...
	return []TEsidNumData{
		...
		{19, 19, 0xd8628c0038bc614e, esidNumABC000000012345678, "AbC:000000012345678"},
		{20, 19, 0xd8628c0038bc614e, esidNumABC000000012345678, "AbC:0000000012345678"},
		{21, 19, 0xd8628c0038bc614e, esidNumABC000000012345678, "AbC:00000000012345678"},
		{22, 19, 0xd8628c0038bc614e, esidNumABC000000012345678, "AbC:000000000012345678"},
		{23, 19, 0xd8628c0038bc614e, esidNumABC000000012345678, "AbC:0000000000012345678"},
		...
		{21, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdE:000000012345678"},
		{22, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdE:0000000012345678"},
		{23, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdE:00000000012345678"},
		{24, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdE:000000000012345678"},
		{25, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdE:0000000000012345678"},
		...
		{23, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdEfG:000000012345678"},
		{24, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdEfG:0000000012345678"},
		{25, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdEfG:00000000012345678"},
		{26, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdEfG:000000000012345678"},
		{27, 21, 0xf8628e4978bc614e, esidNumABCDE000000012345678, "AbCdEfG:0000000000012345678"},
	}
}
...
func TestEncodeStringID(t *testing.T) {
	...
	for _, v := range getEsidTestData() {
		t.Run("", func(t *testing.T) {
			...
			require.Equal(t, v.esid, esid, "The code value is different, expected %#v got %#v", v.esid, esid)
		})
	}
}
...
func TestDecodeStringID(t *testing.T) {
	...
	for _, v := range getEsidTestData() {
		t.Run("", func(t *testing.T) {
			...
			require.Equal(t, v.estr, estr, "The code value is different, expected %#v got %#v", v.estr, estr)
		})
	}
}
...
func TestHashStringID(t *testing.T) {
	...
	for _, v := range getEsidTestData() {
		t.Run("", func(t *testing.T) {
			...
			require.Equal(t, v.hsid, hsid, "The code value is different, expected %#v got %#v", v.hsid, hsid)
		})
	}
}
